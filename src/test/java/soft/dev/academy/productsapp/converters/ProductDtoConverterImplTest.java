...
public class ProductDtoConverterImplTest {
    ...
    public void shouldConvertProductDtoProperly() {
        // GIVEN
        Product product = new Product(5, "egg", ProductType.FOOD, 12);
        // WHEN
        ProductDto productDto = productDtoConverter.convert(product);
        // TODO stworzyc ProductDtoAssert
        Assert.assertEquals(productDto.getName(), "egg");
        Assert.assertEquals(productDto.getType(), "FOOD");
    }
}