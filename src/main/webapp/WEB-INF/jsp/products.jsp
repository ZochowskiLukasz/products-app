...
<body>
	...
	<form action="/products-web/list">
		<table>
			...
			<tr>
				<td>ProductType : <input name="productType" type="text" value=""></td>
			</tr>
			<tr>
    ...
    <table>
        <tr>
            <td>NAME</td><td>quantity</td><td>type</td><td>id</td><td></td><td></td>
        </tr>
        <c:forEach items="${productList}" var="product">
            ...
            <td><a href="<c:url value='/products-web/delete/${product.id}' />"  data-method="delete">Delete</a></td>
            </tr>
        </c:forEach>
    </table>
    <br/>
    <a href="/products-web/new">Add new product</a>
</body>
</html>